...
(function ($) {
  ...
  var googleMap = function () {
    if ($().gmap3) {
      $("#flat-map").gmap3({
        ...
        getlatlng: {
          address:
            "No.B10,ST.25CC7, Songkat Chom Chao, Khan Por Sen Chey, Phnom Penh, Cambodia",
          callback: function (results) {
            if (!results) return;
            $(this)
              .gmap3("get")
              .setCenter(new google.maps.LatLng(11.533369, 104.824589));
            $(this).gmap3({
              marker: {
                latLng: [11.533369, 104.824589],
                options: {},
              },
            });
          },
  ...
  var testimonialSlide = function () {
    $(".flat-testimonials-slider").each(function () {
      $(this)
        .children("#flat-testimonials-carousel")
        .flexslider({
          animation: "slide",
          controlNav: false,
          animationLoop: false,
      ...
      $(this)
        .children("#flat-testimonials-flexslider")
        .flexslider({
          animation: "slide",
          controlNav: false,
          animationLoop: false,
  ...
  var onepage_nav = function () {
    $(".onepage .mainnav > ul > li > a").on("click", function () {
      ...
      var largeScreen = matchMedia("only screen and (min-width: 992px)")
        .matches;
      var headerHeight = 0;
      headerHeight = $(".header").height();
      if (anchor) {
